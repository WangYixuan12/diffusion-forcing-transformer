...
from utils.shared_memory_util import ArraySpec, SharedAtomicCounter
from utils.shared_ndarray import SharedNDArray
...
class SharedMemoryRingBuffer:
    ...
    def __init__(
        ...
        """SharedMemoryRingBuffer constructor
    ...
    def create_from_examples(
        ...
        """Create a SharedMemoryRingBuffer from examples"""
        specs = list()
    ...
    def get(self, out: Optional[dict] = None) -> Dict[str, np.ndarray]:
    ...
    def get_last_k(self, k: int, out: Optional[dict] = None) -> Dict[str, np.ndarray]:
        """Get the last k items in the buffer"""
